...
class TaskService {
  ...
  async createTask(createTaskRequestDTO) {
    ...
    return buildResponse(data, SUCCESS_MESSAGES.TASK_CREATED, STATUS_CODES.CREATED);
  }
  ...
  async getTaskById(id) {
    ...
    return buildResponse(data, SUCCESS_MESSAGES.TASK_RETRIEVED, STATUS_CODES.SUCCESS);
  }
  ...
  async getTasksByWorkspaceId(workspaceId) {
    ...
    return buildResponse(data, SUCCESS_MESSAGES.WORKSPACE_TASKS_RETRIEVED, STATUS_CODES.SUCCESS);
  }
  ...
  async updateTask(id, updateTaskRequestDTO) {
    ...
    const data = new TaskResponseDTO(task);
    return buildResponse(data, SUCCESS_MESSAGES.TASK_UPDATED, STATUS_CODES.SUCCESS);
  }
  ...
  async deleteTask(id) {
    ...
    return buildResponse(data, SUCCESS_MESSAGES.TASK_DELETED, STATUS_CODES.SUCCESS);
  }
}
