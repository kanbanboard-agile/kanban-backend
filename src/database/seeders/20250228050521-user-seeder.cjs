...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const existingUsers = await queryInterface.sequelize.query(`SELECT email FROM "Users" WHERE email IN ('john.doe@example.com', 'jane.smith@example.com', 'admin@example.com');`, { type: Sequelize.QueryTypes.SELECT });
