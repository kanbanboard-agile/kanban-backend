...
// Rute untuk Task
router.post('/create', authMiddleware, TaskController.createTask); // Membuat tugas baru
router.get('/tasks/:id', authMiddleware, TaskController.getTaskById); // Mendapatkan detail tugas
router.get('/workspaces/:workspaceId/tasks', authMiddleware, TaskController.getWorkspaceTasks);
